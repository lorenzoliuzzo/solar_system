...
#include "../tools/shape.h"     
            ...
            class celestial_body : public mass {
                ...
                public: 
                    ...
                    explicit celestial_body(const char* name,
                                            const measurement& mass = 0. * kg, 
                                            const std::shared_ptr<geometry::shapes::_2D::shape>& shape = nullptr, 
                                            const position& pos = position(),
                                            const velocity& vel = velocity(), 
                                            const bool& gravity = true) noexcept : mass::mass(mass, shape, pos, vel, gravity), name_{name} { 
                        
                        object::type_ = "celestial_body";
                    ...
                    explicit celestial_body(const char* name,
                                            ...
                                            bool gravity = true) noexcept : mass::mass(mass, other, gravity), name_{name} {
                    ...
                    celestial_body(const std::shared_ptr<celestial_body>& other) noexcept : mass::mass(other->as_mass()), name_{other->name_} {
                    ...
                    constexpr void name(const char* name) { 
                    ...
                    inline std::shared_ptr<celestial_body> as_celestial_body() const { 
                        
                        return std::make_shared<celestial_body>(*this); 
            ...
            //         std::shared_ptr<measurement> period_;

            //         position aphelion_pos_;

            //         std::shared_ptr<position> perihelion_pos_;

            //         std::shared_ptr<velocity> aphelion_vel_;

            //         std::shared_ptr<velocity> perihelion_vel_;
            ...
            //         explicit planet(const char* name, 
            //                         const std::shared_ptr<measurement>& mass, 
            //                         const std::shared_ptr<geometry::shapes::_2D::circle>& circle, 
            //                         const std::shared_ptr<measurement>& period,
            //                         const std::shared_ptr<position>& aphelion_pos, 
            //                         const std::shared_ptr<position>& perihelion_pos,
            //                         const std::shared_ptr<velocity>& aphelion_vel,
            //                         const std::shared_ptr<velocity>& perihelion_vel) noexcept : 
                                    
            //             celestial_body(name, mass, circle), period_(period),
            //             aphelion_pos_(aphelion_pos), perihelion_pos_(perihelion_pos), aphelion_vel_(aphelion_vel), perihelion_vel_(perihelion_vel) {}
            ...
            //         inline std::shared_ptr<position> pos_aphelion() { 
                        
            //             return aphelion_pos_; 
                    
            //         }


            //         inline std::shared_ptr<position> pos_perihelion() { 
                        
            //             return perihelion_pos_; 
                    
            //         }                
                    

            //         inline std::shared_ptr<velocity> vel_aphelion() { 
                        
            //             return aphelion_vel_; 
                    
            //         }


            //         inline std::shared_ptr<velocity> vel_perihelion() { 
                        
            //             return perihelion_vel_; 
                    
            //         }


            //         inline std::shared_ptr<measurement> period() const { 
